...
## Dicas de pacotes R {#dicas_pacotes}
...
-   Siga conteúdos/pessoas da área
    -   conteúdos: para encontrar materiais e posts procure por #rstats
        (por exemplo: [#rstats no
        twitter/X](https://twitter.com/search?q=%23RStats&src=typeahead_click&f=top)
...
## Sneak Peak de bibliotecas

Vou adicionar aqui algumas contextualizações rápidas de algumas das
bibliotecas citadas na seção [Dicas de pacotes](#dicas_pacotes) 
...
Legal né? Se quiser aprofundar neste uso, a galera da Curso-R tem alguns vídeos no Youtube contextualizando mais sobre ;) 
