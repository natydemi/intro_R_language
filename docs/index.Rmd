...
-   Para ter acesso a tutoriais, livros, lives e cursos, recomendo
    demais a empresa [Curso-R](https://www.curso-r.com/material/)

E caso você tenha interesse em discussões mais avançadas sobre
características da linguagem R:

[Advanced R](http://adv-r.had.co.nz/) e [Hands-On Programming with
...
-   Acompanhe conteúdos/pessoas da área
    ...
    -   pessoas: tem muita gente legal falando de diferentes
        ...
        Curso-R ou R-Ladies por exemplo. Normalmente a partir de dois ou
        três produtores de conteúdo mais engajados, você irá encontrar
        novas pessoas. Por hora, que tal começar comigo? [Aqui minhas
        redes ☺](bit.ly/NathaliaDemetrio)]
