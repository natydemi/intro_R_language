...
- Explorando algumas das classes especiais:
  + prioritariamente: factor, ordered e date
...
- (again) O que é um tibble? 

- O que é o operador Pipe?

- (again) Utilizando a gramática Pipe
